...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { text-align: center; border-bottom: 3px solid #f97316; padding-bottom: 1.5rem; margin-bottom: 2rem; }
        .header h1 { font-size: 24px; color: #f97316; margin-bottom: 0.25rem; }
        ...
        .amount-box { text-align: center; padding: 1.5rem; background: #fff7ed; border: 2px solid #f97316; border-radius: 12px; margin: 2rem 0; }
        .amount-box .total { font-size: 32px; font-weight: 700; color: #f97316; }
        ...
        .detail-table tfoot td { border-top: 2px solid #f97316; font-weight: 700; color: #f97316; }

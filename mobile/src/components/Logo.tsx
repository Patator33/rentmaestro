// Logo RentMaestro — copie du composant web (src/components/Logo.tsx).
// L'app mobile est un projet Vite séparé : elle ne peut pas importer les
// composants Next, d'où cette duplication volontaire. Garder les deux
// fichiers synchronisés si le logo évolue.

    ...
    <div className="pb-nav safe-top overflow-y-auto" style={{ height: '100%' }}>
      <div className="px-4 py-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Field label="Surface (m²)" type="number" value={form.surface} onChange={set('surface')} />
          <div>
            <label className="block text-xs text-text-secondary mb-1">DPE</label>
            <select value={form.dpe} onChange={set('dpe')} className="w-full bg-surface border border-border rounded-xl px-3 py-2.5 text-text-main text-sm focus:outline-none focus:border-primary">
